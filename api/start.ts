...
<aside class="panel"><small>OFFICIAL ACCESS FLOW</small><h2>Free install. Free account. Public access.</h2><div class="flow">
...
<p class="intro">Learning Campus provides education. Financial tools help diagnose and plan. DPBS supports resource control and multiplication. Marketplace provides a place to execute. Wallet records movement and Tracker provides evidence. Private applications are temporarily isolated while stability testing is in progress.</p>
<div class="grid">
...
<p>Install or open the public DELIONARYO App and create your account for free. No activation code is required. Learn the system and explore the Store while private applications remain isolated for stability testing.</p>
<div class="actions" style="justify-content:center"><a class="primary" href="https://app.gapcreation.space/">ENTER DELIONARYO →</a><a class="secondary" href="https://app.gapcreation.space/#store">GO TO STORE →</a></div>
</section>
</main>
