...
<meta name="description" content="Open the official DELIONARYO app in your browser and install it on your phone."/>
<meta property="og:title" content="DELIONARYO — From Mind to Steward"/>
<meta property="og:description" content="Open the official DELIONARYO app. Learn, execute, transform and steward."/>
...
<meta name="twitter:description" content="Open the official DELIONARYO app."/>
...
<h1>Open DELIONARYO</h1>
<p class="lead">For the best experience and app installation, open DELIONARYO in Google Chrome.</p>
<div class="notice" id="metaNotice"><b>Facebook / Messenger user?</b><br/>Tap <b>OPEN IN CHROME</b>. If your phone keeps this page inside Facebook or Messenger, tap the <b>⋮</b> menu above and choose <b>Open in external browser</b>.</div>
<div class="actions">
...
(function(){
  ...
  if(!isAndroid){chrome.href=target;chrome.textContent='OPEN DELIONARYO';}
