...
<style>
.mark{overflow:hidden}.mark img{width:100%;height:100%;object-fit:cover;display:block}.appNavActions{display:flex;align-items:center;justify-content:flex-end;gap:9px;flex-wrap:wrap}.installAppBtn{color:#0e1215;background:#d9aa3c;border:1px solid #d9aa3c;padding:11px 15px;border-radius:11px;font-weight:900;cursor:pointer}.installAppBtn[hidden]{display:none}@media(max-width:700px){.appNavActions{max-width:64%}.installAppBtn{font-size:12px;padding:10px 12px}}
